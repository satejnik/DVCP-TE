function [hx,hy] = ...
    format_ticks(h,tickx,ticky,tickposx,tickposy,rotx,roty,offsetx,offsety,varargin)
%Name: format_tick.m
%
%Usage: [hx,hy] = format_tick(h,tickx,ticky,tickposx,tickposy,rotx,roty,...
%                  offsetx,offsety,varargin);
%
...
elseif rotx < 0;
    ...
    if latex_on;
        ...
        hx = text(tickposx,...
            repmat(lim(1)-offsetx*(lim(2)-lim(2)),length(tickposx),1),...
